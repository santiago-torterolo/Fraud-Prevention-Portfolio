...
02_SQL_Fraud_Audit/
├── data/
│ ├── .gitkeep # Placeholder (DB is generated locally)
│ └── (paysim_audit.db) # SQLite DB generated by setup script
│
├── sql/
│ ├── 1_structuring_alert.sql # SQL Logic: Smurfing detection
│ └── 2_velocity_alert.sql # SQL Logic: High-velocity bot detection
│
├── src/
│ ├── setup_audit_db.py # ETL: Simulates PaySim data & loads DB
│ └── run_audit.py # Execution: Runs queries & reports alerts
│
